...
- **Database Agnostic**: SQL Server, PostgreSQL, MySQL, SQLite, Oracle, DB2, ODBC, OleDb
...
- .NET 10+ runtime
- A database (SQL Server, PostgreSQL, MySQL, SQLite, Oracle, DB2, or any ODBC/OleDb data source)
